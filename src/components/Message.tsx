  ...
  return (
    ...
    >
      ...
      <div className='flex items-center p-2 rounded-full bg-[#222222] absolute left-1 -top-8'>
        <div
          className={`flex justify-center items-center h-[3.15rem] w-[3.15rem] rounded-full bg-gradient-to-b ${getOrnament(
            message.badges,
          )}`}
        >
          <img
      ...
      <div
        className={`flex justify-center items-center w-[98%] rounded-3xl rounded-tl-none p-[.17rem] m-1 bg-gradient-to-b ${getOrnament(
          message.badges,
        )}`}
      >
        <div
